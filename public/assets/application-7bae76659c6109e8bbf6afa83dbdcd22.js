...
(function() {
  $(document).ready(function() {
    ...
    $('section#calendar').waypoint(function(direction) {
      var activeNav;
      activeNav = $(this).attr('id');
      switch (direction) {
        case 'up':
          return $('.navbar a[href="#' + activeNav + '"]').removeClass('active');
        case 'down':
          return $('.navbar a[href="#' + activeNav + '"]').addClass('active');
      }
    }, {
      offset: 115
    });
    $('section#join').waypoint(function(direction) {
      var activeNav;
      activeNav = $(this).attr('id');
      switch (direction) {
        case 'up':
          $('.navbar a[href="#' + activeNav + '"]').removeClass('active');
          return $('.navbar a[href="#calendar"]').addClass('active');
        case 'down':
          $('.navbar a[href="#' + activeNav + '"]').addClass('active');
          return $('.navbar a[href="#calendar"]').removeClass('active');
      }
    }, {
      offset: 115
    });
    $('section#contact').waypoint(function(direction) {
      ...
      switch (direction) {
        case 'up':
          $('.navbar a[href="#' + activeNav + '"]').removeClass('active');
          return $('.navbar a[href="#join"]').addClass('active');
        case 'down':
          $('.navbar a[href="#' + activeNav + '"]').addClass('active');
          return $('.navbar a[href="#join"]').removeClass('active');
      }
    }, {
      offset: 258
    });
    return $('form#contact-form').submit(function(e) {
      ...
      return $.ajax('/send_message', {
        ...
        success: function(data, textStatus, jqXHR) {
          $('form#contact-form input, form#contact-form textarea, form#contact-form .btn, form#contact-form label').css({
            opacity: '0.2'
          });
          return $('#contact .success').fadeIn();
        }
      });
    });
  });
